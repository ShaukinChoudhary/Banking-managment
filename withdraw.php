<html>
    ...
    <body text=darkblue bgcolor="lightblue" style="background-repeat: no-repeat; background-attachment: fixed; background-size: 100% 100%;">
       <form method=post>
        <center>
            <fieldset style="background-color:white;border-width:1px ;border-color:darkblue;width:40%;height:45%;">
            
            <u><h2 style="color:red">WITHDRAW AMOUNT</h2></u>                
